...
var togglemenu = document.querySelector(".head-title-phone");
...
// more-subject-show
const moresubcard = document.querySelector(".more-sub-cards");
const submore = document.querySelector(".sub-card-more");
const subless = document.querySelector(".sub-card-less");
function moreSub() {
    moresubcard.classList.toggle("more-sub-cards-height");
    submore.classList.toggle("d-n");
    subless.classList.toggle("d-f");
}